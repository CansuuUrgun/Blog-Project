...
//    {
//        //var post = Post.Create(req.Title, req.Content, req.Author);
//        //await postRepository.AddAsync(post);

//        //return new PostResponse(post.Id, post.Title, post.Content, post.CreatedAt, post.UpdatedAt, post.Author.Username);
//    }
...
//        return posts.Select(p => new PostResponse(p.Id, p.Title, p.Content, p.CreatedAt, p.UpdatedAt, p.Author.Username));
//    }
...
//        return new PostResponse(updated.Id, updated.Title, updated.Content, updated.CreatedAt, updated.UpdatedAt, updated.Author.Username);
//    }
//}
